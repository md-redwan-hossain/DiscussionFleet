        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverImageFileExtension = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("MinBlogBodyLength", "LEN([Body]) >= 30");
                    table.CheckConstraint("MinBlogTitleLength", "LEN([Title]) >= 1");
                });
