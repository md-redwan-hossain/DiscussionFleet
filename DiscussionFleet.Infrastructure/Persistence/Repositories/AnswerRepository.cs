...
public class AnswerRepository : Repository<Answer, AnswerId>, IAnswerRepository
{
    ...
    public async Task<PagedData<Answer>> GetAnswers(QuestionId questionId, int page, int limit, AnswerSortCriteria sortBy)
    {
